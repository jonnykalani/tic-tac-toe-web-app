...
var updateGameCell = function updateGameCell(index, player) {
...
var oppositePlayer = void 0;
var otherPlayer = function otherPlayer() {
...
var winChecker = function winChecker(array, i) {
  if (over !== true && (array[0] === array[1] && array[1] === array[2] && array[0] !== undefined || array[0] === array[4] && array[4] === array[8] && array[0] !== undefined || array[0] === array[3] && array[3] === array[6] && array[0] !== undefined || array[1] === array[4] && array[4] === array[7] && array[1] !== undefined || array[2] === array[5] && array[5] === array[8] && array[2] !== undefined || array[3] === array[4] && array[4] === array[5] && array[3] !== undefined || array[6] === array[7] && array[7] === array[8] && array[6] !== undefined || array[2] === array[4] && array[4] === array[6] && array[2] !== undefined)) {
    otherPlayer();
  ...
  } else if (array[0] == null || array[1] == null || array[2] == null || array[3] == null || array[4] == null || array[5] == null || array[6] == null || array[7] == null || array[8] == null) {
...
var pushMove = function pushMove(i, board) {
...
var playerMove = function playerMove(i, board) {
  pushMove(i, board);
...
var boardReset = function boardReset(board) {
  board = [];
  currentBoard = [board];
  over = false;
  currentPlayer = playerX;
...
var gameIndex = __webpack_require__(1);

var onSignUp = function onSignUp(event) {
  event.preventDefault();
  var data = getFormFields(this);
  gameApi.signUp(data).then(gameUi.onSignUpSuccess).catch(gameUi.onError);
...
var onChangePassword = function onChangePassword(event) {
  ...
  gameApi.changePassword(data).then(gameUi.changePasswordSuccess).catch(gameUi.changePasswordFailure);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  gameApi.signOut(data).then(gameUi.signOutSuccess).catch(gameUi.signOutFailure);
};
...
var onNewGame = function onNewGame(event) {
  ...
  var data = getFormFields(event.target);
  gameLogic.endGame();
  gameApi.newGame(data).then(gameUi.newGameSuccess).catch(gameUi.newGameFailure);
...
var onClickCell = function onClickCell(event) {
  ...
  var cellClass = event.data.cellClass;
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  gameApi.getGames().then(gameUi.getGamesSuccess);
};
...
var cellClickSuccess = function cellClickSuccess(data, index, cellClass) {
...
module.exports = {
  ...
  cellClickSuccess: cellClickSuccess,
